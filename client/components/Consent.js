...
const Consent = (props) => {
  ...
  return (
    <div>
      <Typography className={classes.title}>Giriş Yap</Typography>
      <br />
      <Typography className={classes.privacyText}>
        Devam tuşuna basarak kişisel verilerimin işlenmesine ilişkin
        <Link
          href="https://drive.google.com/file/d/1MvxTx1zHBDCfd8rTqGVXgnM_IWZZqViF/view"
      ...
      <Typography className={classes.privacyText}>
        ...
        <Link
          href="https://drive.google.com/file/d/1xR2rMXDo_ffPRW9cRAswvjIpZ11nsNA1/view"
          className={classes.outLink}
        >
          <a target="_blank"> Açık Rıza Metni</a>
        </Link>
        ’ni okuduğumu, anladığımı ve kişisel verilerimin yurt dışına aktarılmasına rızam olduğunu
